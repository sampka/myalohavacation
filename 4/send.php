...
$AriveMonth = $_POST['AriveMonth'];
$AriveDay = $_POST['AriveDay'];
$AriveYear = $_POST['AriveYear'];
$DepartMonth = $_POST['DepartMonth'];
$DepartDay = $_POST['DepartDay'];
$DepartYear = $_POST['DepartYear'];
$PAddress = $_POST['PAddress'];
$hPhone = $_POST['hPhone'];
$hPhone2 = $_POST['hPhone2'];
$hPhone4 = $_POST['hPhone4'];
$cPhone = $_POST['cPhone'];
$cPhone2 = $_POST['cPhone2'];
$cPhone3 = $_POST['cPhone3'];
$employ =  $_POST['employ'];
$employaddress =  $_POST['employaddress'];
$ContactPandP =  $_POST['ContactPand'];
$conPhone =  $_POST['conPhone'];
$conPhone3 =  $_POST['conPhone3'];
$conPhone4 =  $_POST['conPhone4'];
$EContactname =  $_POST['EContactname'];
$EContactAddress =  $_POST['EContactAddress'];
$ePhone1 =  $_POST['ePhone1'];
$ePhone2 =  $_POST['ePhone2'];
$ePhone3 =  $_POST['ePhone3'];
$_parking =  $_POST['_parking'];
...
$urlreturn = 'http://www.myalohavacation.com/4/application.html'; 
